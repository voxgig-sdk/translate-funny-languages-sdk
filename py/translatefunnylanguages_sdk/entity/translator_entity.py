...
from translatefunnylanguages_sdk.translatefunnylanguages_types import (
    Translator,
    TranslatorLoadMatch,
...
class TranslatorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TranslatorEntity(self._client, opts)
    ...
    def create(self, reqdata: TranslatorCreateData, ctrl=None) -> Translator:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
