...
from translatefunnylanguages_sdk.core.control import TranslateFunnyLanguagesControl
...
from translatefunnylanguages_sdk.core.helpers import get_ctx_prop, to_map
...
class TranslateFunnyLanguagesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = TranslateFunnyLanguagesControl()
        ...
        if isinstance(sp, TranslateFunnyLanguagesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TranslateFunnyLanguagesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TranslateFunnyLanguagesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return TranslateFunnyLanguagesOperation({})
        ...
        op = TranslateFunnyLanguagesOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return TranslateFunnyLanguagesError(code, msg, self)
