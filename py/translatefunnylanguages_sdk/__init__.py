...
from translatefunnylanguages_sdk.utility import register

# Load features
from translatefunnylanguages_sdk.feature.base_feature import TranslateFunnyLanguagesBaseFeature
from translatefunnylanguages_sdk.features import _has_feature, _make_feature
...
class TranslateFunnyLanguagesSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = TranslateFunnyLanguagesUtility()
        self._utility = utility

        from translatefunnylanguages_sdk.config import shared_config
    ...
    def get_utility(self):
        return TranslateFunnyLanguagesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TranslateFunnyLanguagesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Translator(self, data=None) -> "TranslatorEntity":
        ...
        from translatefunnylanguages_sdk.entity.translator_entity import TranslatorEntity
        return TranslatorEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "TranslateFunnyLanguagesSDK":
        if sdkopts is None:
            sdkopts = {}
