# TranslateFunnyLanguages SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TranslateFunnyLanguagesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TranslateFunnyLanguagesSDK(...) and TranslateFunnyLanguagesSDK.test(...) become
#      TranslateFunnyLanguagesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "translatefunnylanguages_sdk"
_SDK_CLASS = "TranslateFunnyLanguagesSDK"
