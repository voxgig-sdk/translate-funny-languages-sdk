# TranslateFunnyLanguages SDK feature test harness
#
...
class _Ctx:
    ...
    def __init__(self, client, utility, op=None, entity=None, ctrl=None):
        ...
        self.out = {}
        self.ctrl = ctrl if ctrl is not None else TranslateFunnyLanguagesControl()
        self.meta = {}
        self.op = op
        self.entity = entity
        self.spec = None
...
class Harness:
    ...
    def _populate_result(self, ctx, response, fetch_err):
        result = TranslateFunnyLanguagesResult({})
        ctx.result = result
    ...
    def op(self, op="load", entity="widget", method=None, path=None,
        ...
        ctx = _Ctx(self.client, self.utility,
                   ...
                   ctrl=TranslateFunnyLanguagesControl(ctrl or {}))
        ...
        try:
            ...
            if spec is None:
                ...
                for key, val in (headers or {}).items():
                    merged[key] = val
                spec = TranslateFunnyLanguagesSpec({
                    "method": method,
                    "base": self.base,
