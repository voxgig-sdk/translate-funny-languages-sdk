...
#      offline in seeded test mode (TranslateFunnyLanguagesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "TranslateFunnyLanguages_sdk.rb")
  SDK_CLASS = "TranslateFunnyLanguagesSDK"
  ...
  SDK_BASE = "TranslateFunnyLanguages_sdk"
