...
require_relative 'TranslateFunnyLanguages_types'
...
class TranslateFunnyLanguagesSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = TranslateFunnyLanguagesHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = TranslateFunnyLanguagesHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, TranslateFunnyLanguagesFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    TranslateFunnyLanguagesUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = TranslateFunnyLanguagesHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = TranslateFunnyLanguagesHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = TranslateFunnyLanguagesHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => TranslateFunnyLanguagesError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue TranslateFunnyLanguagesError => err
    ...
    if fetched.is_a?(Hash)
      status = TranslateFunnyLanguagesHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = TranslateFunnyLanguagesError.new(
        "graphql_error", "TranslateFunnyLanguagesSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = TranslateFunnyLanguagesSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
