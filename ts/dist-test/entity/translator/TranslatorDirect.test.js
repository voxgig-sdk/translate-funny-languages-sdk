...
(0, node_test_1.describe)('TranslatorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.TranslateFunnyLanguagesSDK({
    ...
    (0, node_test_1.test)('direct-load-translator', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-translator', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.TRANSLATE_FUNNY_LANGUAGES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TranslateFunnyLanguagesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['TRANSLATE_FUNNY_LANGUAGES_TEST_TRANSLATOR_ENTID'];
    ...
    const client = new __1.TranslateFunnyLanguagesSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=TranslatorDirect.test.js.map