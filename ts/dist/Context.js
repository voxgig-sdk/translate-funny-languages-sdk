...
const TranslateFunnyLanguagesError_1 = require("./TranslateFunnyLanguagesError");
...
class Context {
    ...
    error(code, msg) {
        return new TranslateFunnyLanguagesError_1.TranslateFunnyLanguagesError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
