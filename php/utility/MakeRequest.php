...
// TranslateFunnyLanguages SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TranslateFunnyLanguagesMakeRequest
{
    public static function call(TranslateFunnyLanguagesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TranslateFunnyLanguagesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TranslateFunnyLanguagesResponse($fetched);
        } else {
