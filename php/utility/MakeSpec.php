...
// TranslateFunnyLanguages SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class TranslateFunnyLanguagesMakeSpec
{
    public static function call(TranslateFunnyLanguagesContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = TranslateFunnyLanguagesGraphql::CONTENT_TYPE;
        } else {
