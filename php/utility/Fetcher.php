...
// TranslateFunnyLanguages SDK utility: fetcher

class TranslateFunnyLanguagesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TranslateFunnyLanguagesSDK/1.0)';
    ...
    public static function call(TranslateFunnyLanguagesContext $ctx, string $fullurl, array $fetchdef): array
    {
