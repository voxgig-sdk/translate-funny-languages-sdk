...
// TranslateFunnyLanguages SDK utility: result_basic

class TranslateFunnyLanguagesResultBasic
{
    public static function call(TranslateFunnyLanguagesContext $ctx): ?TranslateFunnyLanguagesResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof TranslateFunnyLanguagesError) ? $result->err->msg : (string)$result->err;
