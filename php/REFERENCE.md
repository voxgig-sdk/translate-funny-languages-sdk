# TranslateFunnyLanguages PHP SDK Reference

Complete API reference for the TranslateFunnyLanguages PHP SDK.
...
#### `TranslateFunnyLanguagesSDK::test($testopts = null, $sdkopts = null)`
