...
// TranslateFunnyLanguages SDK utility type

class TranslateFunnyLanguagesUtility
{
    ...
    public static function copy(TranslateFunnyLanguagesUtility $src): TranslateFunnyLanguagesUtility
    {
        $u = new TranslateFunnyLanguagesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
