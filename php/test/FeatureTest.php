...
// TranslateFunnyLanguages SDK feature test
//
...
class FtCtrl extends TranslateFunnyLanguagesControl
{
...
class FtClient
{
    ...
    private TranslateFunnyLanguagesUtility $utility;

    public function __construct(TranslateFunnyLanguagesUtility $utility, array $options)
    {
    ...
    public function get_utility(): TranslateFunnyLanguagesUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (TranslateFunnyLanguagesContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public TranslateFunnyLanguagesContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (TranslateFunnyLanguagesContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = TranslateFunnyLanguagesConfig::make_feature($name);
    ...
    private static function buildUrl(TranslateFunnyLanguagesSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof TranslateFunnyLanguagesError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new TranslateFunnyLanguagesResponse($fetched);
        }
    ...
    private function fail(TranslateFunnyLanguagesContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (TranslateFunnyLanguagesContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
