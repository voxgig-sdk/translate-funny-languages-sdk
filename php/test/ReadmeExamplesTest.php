...
// TranslateFunnyLanguages SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TranslateFunnyLanguagesSDK::test)
...
{
    private const SDK_CLASS = 'TranslateFunnyLanguagesSDK';
    ...
    private const SDK_BASE = 'translatefunnylanguages_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../translatefunnylanguages_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
