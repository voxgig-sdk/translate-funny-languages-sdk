...
// TranslateFunnyLanguages SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TranslateFunnyLanguagesOmni::makeStructRunner(
    ...
    {
        return TranslateFunnyLanguagesOmni::objmodel(TranslateFunnyLanguagesOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return TranslateFunnyLanguagesOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return TranslateFunnyLanguagesOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TranslateFunnyLanguagesOmni::structfix($now, Struct::undef()))
                        !== json_encode(TranslateFunnyLanguagesOmni::structfix($val, Struct::undef()))) {
