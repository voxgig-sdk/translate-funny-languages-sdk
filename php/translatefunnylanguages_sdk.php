...
class TranslateFunnyLanguagesSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = TranslateFunnyLanguagesHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = TranslateFunnyLanguagesHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!TranslateFunnyLanguagesFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, TranslateFunnyLanguagesFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return TranslateFunnyLanguagesUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = TranslateFunnyLanguagesHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = TranslateFunnyLanguagesHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = TranslateFunnyLanguagesHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new TranslateFunnyLanguagesError($op . "_allow",
                "TranslateFunnyLanguagesSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = TranslateFunnyLanguagesHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new TranslateFunnyLanguagesError("graphql_error",
                "TranslateFunnyLanguagesSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Translator($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_translator === null) {
                $this->_translator = new TranslatorEntity($this, null);
            }
            return $this->_translator;
        }
        return new TranslatorEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new TranslateFunnyLanguagesSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
