...
// TranslateFunnyLanguages SDK metrics feature
...
class TranslateFunnyLanguagesMetricsFeature extends TranslateFunnyLanguagesBaseFeature
{
    ...
    private function _record(TranslateFunnyLanguagesContext $ctx, bool $ok): void
    {
