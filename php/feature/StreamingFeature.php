...
// TranslateFunnyLanguages SDK streaming feature
...
class TranslateFunnyLanguagesStreamingFeature extends TranslateFunnyLanguagesBaseFeature
{
    ...
    private function _iterate(TranslateFunnyLanguagesResult $result): \Generator
    {
    ...
    private function _streamable(TranslateFunnyLanguagesContext $ctx): bool
    {
