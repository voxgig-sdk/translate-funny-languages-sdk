...
// TranslateFunnyLanguages SDK telemetry feature
...
class TranslateFunnyLanguagesTelemetryFeature extends TranslateFunnyLanguagesBaseFeature
{
    ...
    private function _close(TranslateFunnyLanguagesContext $ctx, bool $ok): void
    {
