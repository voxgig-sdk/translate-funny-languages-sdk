...
// TranslateFunnyLanguages SDK proxy feature
...
class TranslateFunnyLanguagesProxyFeature extends TranslateFunnyLanguagesBaseFeature
{
    ...
    public function init(TranslateFunnyLanguagesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TranslateFunnyLanguagesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
