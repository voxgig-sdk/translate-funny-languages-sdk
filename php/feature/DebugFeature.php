...
// TranslateFunnyLanguages SDK debug feature
...
class TranslateFunnyLanguagesDebugFeature extends TranslateFunnyLanguagesBaseFeature
{
    ...
    private function _finish(TranslateFunnyLanguagesContext $ctx, bool $ok): void
    {
