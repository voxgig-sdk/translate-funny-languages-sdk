...
// TranslateFunnyLanguages SDK cache feature
...
class TranslateFunnyLanguagesCacheFeature extends TranslateFunnyLanguagesBaseFeature
{
    ...
    private function _through(TranslateFunnyLanguagesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
