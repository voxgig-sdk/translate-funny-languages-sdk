...
// TranslateFunnyLanguages SDK paging feature
...
class TranslateFunnyLanguagesPagingFeature extends TranslateFunnyLanguagesBaseFeature
{
    ...
    private function _is_list(TranslateFunnyLanguagesContext $ctx): bool
    {
