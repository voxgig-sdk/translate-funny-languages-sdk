...
type TranslatorEntity struct {
	name    string
	client  *core.TranslateFunnyLanguagesSDK
...
func NewTranslatorEntity(client *core.TranslateFunnyLanguagesSDK, entopts map[string]any) *TranslatorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TranslatorEntity) GetName() string { return e.name }
...
func (e *TranslatorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TranslatorEntity) Deleted() bool {
	return e.deleted
}


func (e *TranslatorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTranslatorEntity(e.client, opts)
}

func (e *TranslatorEntity) Data(args ...any) any {
...
func (e *TranslatorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Translator; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TranslatorEntity) DataTyped(data ...Translator) Translator {
	if len(data) > 0 {
		return typedFrom[Translator](e.Data(asMap(data[0])))
	}
	return typedFrom[Translator](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Translator (all fields
// optional at the wire level).
func (e *TranslatorEntity) MatchTyped(match ...Translator) Translator {
	if len(match) > 0 {
		return typedFrom[Translator](e.Match(asMap(match[0])))
	}
	return typedFrom[Translator](e.Match())
}
...
func (e *TranslatorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TranslatorEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TranslatorLoadMatch and returns an Translator. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TranslatorEntity) LoadTyped(reqmatch TranslatorLoadMatch, ctrl map[string]any) (Translator, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Translator{}, err
	}
	return typedFrom[Translator](res), nil
}



func (e *TranslatorEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *TranslatorEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// TranslatorCreateData and returns an Translator. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TranslatorEntity) CreateTyped(reqdata TranslatorCreateData, ctrl map[string]any) (Translator, error) {
...
func (e *TranslatorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TranslatorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TranslatorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
