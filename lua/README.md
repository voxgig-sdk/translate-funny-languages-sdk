...
```lua
-- Create
local created, err = client:Translator():create({ translator = "example_translator" })
if err then error(err) end
...
```
lua/
├── translate-funny-languages_sdk.lua    -- Main SDK module
...
The main module (`translate-funny-languages_sdk`) exports the SDK constructor
