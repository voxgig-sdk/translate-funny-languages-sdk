...
local TranslatorEntity = {}
TranslatorEntity.__index = TranslatorEntity


function TranslatorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TranslatorEntity)
...
function TranslatorEntity:get_name()
  return self._name
end


function TranslatorEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TranslatorEntity.new(self._client, opts)
end
...
function TranslatorEntity:mark_deleted()
  self._deleted = true
end


function TranslatorEntity:deleted()
  return true == self._deleted
end


function TranslatorEntity:data_set(args)
  if args ~= nil then
...
function TranslatorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TranslatorEntity:match_set(args)
  if args ~= nil then
...
function TranslatorEntity:match_get()
...
function TranslatorEntity:stream(action, args, callopts)
...
function TranslatorEntity:_run_op(ctx, post_done)
  local utility = self._utility
