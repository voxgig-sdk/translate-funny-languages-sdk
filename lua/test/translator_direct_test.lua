...
describe("TranslatorDirect", function()
  it("should direct-load-translator", function()
    local setup = translator_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-translator", setup.live and "live" or "unit")
...
function translator_direct_setup(mockres)
