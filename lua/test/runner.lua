...
function runner.env_override(m)
  local live = runner.getenv("TRANSLATE_FUNNY_LANGUAGES_TEST_LIVE")
  local override = runner.getenv("TRANSLATE_FUNNY_LANGUAGES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TRANSLATE_FUNNY_LANGUAGES_TEST_EXPLAIN")
