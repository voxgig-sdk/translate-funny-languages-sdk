...
function runner.env_override(m)
  local live = runner.getenv("TRANSLATEFUNNYLANGUAGES_TEST_LIVE")
  local override = runner.getenv("TRANSLATEFUNNYLANGUAGES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TRANSLATEFUNNYLANGUAGES_TEST_EXPLAIN")
