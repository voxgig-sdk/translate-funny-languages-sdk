...
|---|---|---|
| `ts/` | @voxgig-sdk/translate-funny-languages-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/translate-funny-languages-sdk \
      --repository voxgig-sdk/translate-funny-languages-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/translate-funny-languages-sdk` shows it, and
`npm trust revoke @voxgig-sdk/translate-funny-languages-sdk --id=<id>` removes it.
