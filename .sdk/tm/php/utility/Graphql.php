...
// TranslateFunnyLanguages SDK utility: graphql
//
...
class TranslateFunnyLanguagesGraphql
{
    ...
    // equivalent.
    public static function body(TranslateFunnyLanguagesContext $ctx): mixed
    {
    ...
    public static function errors(TranslateFunnyLanguagesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
