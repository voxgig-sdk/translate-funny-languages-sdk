...
// TranslateFunnyLanguages SDK utility: make_options

class TranslateFunnyLanguagesMakeOptions
{
    ...
    public static function call(TranslateFunnyLanguagesContext $ctx): array
    {
        ...
        //
        // `TranslateFunnyLanguagesSchema::optspec()` is built from the model:
        ...
        $optspec = TranslateFunnyLanguagesSchema::optspec();
