...
// TranslateFunnyLanguages SDK pipeline test
//
...
{
    private static function utility(): TranslateFunnyLanguagesUtility
    {
        return new TranslateFunnyLanguagesUtility();
    }
    ...
    private static function ctx(array $over = []): TranslateFunnyLanguagesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new TranslateFunnyLanguagesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new TranslateFunnyLanguagesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof TranslateFunnyLanguagesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new TranslateFunnyLanguagesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = TranslateFunnyLanguagesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new TranslateFunnyLanguagesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = TranslateFunnyLanguagesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new TranslateFunnyLanguagesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = TranslateFunnyLanguagesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TranslateFunnyLanguagesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = TranslateFunnyLanguagesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new TranslateFunnyLanguagesResponse([]),
            'result' => new TranslateFunnyLanguagesResult([]),
        ]);
        [, $err] = TranslateFunnyLanguagesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new TranslateFunnyLanguagesSpec([]),
            'response' => null,
            'result' => new TranslateFunnyLanguagesResult([]),
        ]);
        [, $err] = TranslateFunnyLanguagesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new TranslateFunnyLanguagesSpec(['step' => 's']),
            'response' => new TranslateFunnyLanguagesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new TranslateFunnyLanguagesResult([]),
        ]);
        [, $err] = TranslateFunnyLanguagesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new TranslateFunnyLanguagesSpec(['step' => 's']),
            'response' => new TranslateFunnyLanguagesResponse(self::resp(200, ['v' => 1])),
            'result' => new TranslateFunnyLanguagesResult([]),
        ]);
        [, $err] = TranslateFunnyLanguagesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new TranslateFunnyLanguagesSpec(['step' => 's']),
            'response' => new TranslateFunnyLanguagesResponse(self::resp(200, ['v' => 2])),
            'result' => new TranslateFunnyLanguagesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        TranslateFunnyLanguagesMakeResponse::call($ctx);
    ...
    {
        $preset = new TranslateFunnyLanguagesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new TranslateFunnyLanguagesSpec([]),
            'response' => new TranslateFunnyLanguagesResponse([]),
            'result' => new TranslateFunnyLanguagesResult([]),
        ...
        [$got, $err] = TranslateFunnyLanguagesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new TranslateFunnyLanguagesResult([])]);
        [, $err] = TranslateFunnyLanguagesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new TranslateFunnyLanguagesSpec([]), 'result' => null]);
        [, $err] = TranslateFunnyLanguagesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TranslateFunnyLanguagesSpec(['step' => 's']),
            'result' => new TranslateFunnyLanguagesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new TranslateFunnyLanguagesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TranslateFunnyLanguagesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TranslateFunnyLanguagesSpec(['step' => 's']),
            'result' => new TranslateFunnyLanguagesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new TranslateFunnyLanguagesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TranslateFunnyLanguagesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TranslateFunnyLanguagesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new TranslateFunnyLanguagesSpec([]),
            'result' => new TranslateFunnyLanguagesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = TranslateFunnyLanguagesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TranslateFunnyLanguagesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new TranslateFunnyLanguagesError('boom', 'boom');
        $utility->fetcher = function (TranslateFunnyLanguagesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TranslateFunnyLanguagesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = TranslateFunnyLanguagesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (TranslateFunnyLanguagesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = TranslateFunnyLanguagesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(TranslateFunnyLanguagesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        TranslateFunnyLanguagesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (TranslateFunnyLanguagesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TranslateFunnyLanguagesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = TranslateFunnyLanguagesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new TranslateFunnyLanguagesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new TranslateFunnyLanguagesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = TranslateFunnyLanguagesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = TranslateFunnyLanguagesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = TranslateFunnyLanguagesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new TranslateFunnyLanguagesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, TranslateFunnyLanguagesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new TranslateFunnyLanguagesResult(['ok' => false])]);
        $this->expectException(TranslateFunnyLanguagesError::class);
        TranslateFunnyLanguagesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new TranslateFunnyLanguagesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', TranslateFunnyLanguagesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        TranslateFunnyLanguagesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new TranslateFunnyLanguagesBaseFeature();
        $b = new TranslateFunnyLanguagesBaseFeature();
        TranslateFunnyLanguagesFeatureAdd::call($ctx, $a);
        TranslateFunnyLanguagesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): TranslateFunnyLanguagesBaseFeature
    {
        $f = new TranslateFunnyLanguagesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        TranslateFunnyLanguagesFeatureAdd::call($ctx, self::named_feature('a'));
        TranslateFunnyLanguagesFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        TranslateFunnyLanguagesFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        TranslateFunnyLanguagesFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        TranslateFunnyLanguagesFeatureAdd::call($ctx, $replace);
        ...
        TranslateFunnyLanguagesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): TranslateFunnyLanguagesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new TranslateFunnyLanguagesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TranslateFunnyLanguagesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        TranslateFunnyLanguagesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new TranslateFunnyLanguagesResponse(['headers' => null]),
            'result' => new TranslateFunnyLanguagesResult([]),
        ]);
        TranslateFunnyLanguagesResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        TranslateFunnyLanguagesResultBody::call($ctx);
