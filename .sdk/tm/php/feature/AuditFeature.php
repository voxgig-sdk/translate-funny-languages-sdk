...
// TranslateFunnyLanguages SDK audit feature
...
class TranslateFunnyLanguagesAuditFeature extends TranslateFunnyLanguagesBaseFeature
{
    ...
    private function _emit(TranslateFunnyLanguagesContext $ctx, string $outcome): void
    {
