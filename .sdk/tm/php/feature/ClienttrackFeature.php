...
// TranslateFunnyLanguages SDK clienttrack feature
...
class TranslateFunnyLanguagesClienttrackFeature extends TranslateFunnyLanguagesBaseFeature
{
    ...
    public function PostConstruct(TranslateFunnyLanguagesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TranslateFunnyLanguages-SDK';
