...
// TranslateFunnyLanguages SDK netsim feature
...
class TranslateFunnyLanguagesNetsimFeature extends TranslateFunnyLanguagesBaseFeature
{
    ...
    private function _simulate(TranslateFunnyLanguagesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TranslateFunnyLanguagesContext $ctx, array $applied): void
    {
        $client = $this->client;
