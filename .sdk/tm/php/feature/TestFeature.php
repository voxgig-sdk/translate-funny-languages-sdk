...
// TranslateFunnyLanguages SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TranslateFunnyLanguagesTestFeature extends TranslateFunnyLanguagesBaseFeature
{
    ...
    public function init(TranslateFunnyLanguagesContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TranslateFunnyLanguagesContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = TranslateFunnyLanguagesParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TranslateFunnyLanguagesContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TranslateFunnyLanguagesContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = TranslateFunnyLanguagesParam::call($ctx, $k);
