...
// TranslateFunnyLanguages SDK rbac feature
...
class TranslateFunnyLanguagesRbacFeature extends TranslateFunnyLanguagesBaseFeature
{
    ...
    private function _required(TranslateFunnyLanguagesContext $ctx): ?string
    {
    ...
    private function _reject(TranslateFunnyLanguagesContext $ctx, string $required): void
    {
    ...
    private function _track(TranslateFunnyLanguagesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
