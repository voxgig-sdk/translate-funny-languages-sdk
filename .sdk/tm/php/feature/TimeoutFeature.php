...
// TranslateFunnyLanguages SDK timeout feature
...
class TranslateFunnyLanguagesTimeoutFeature extends TranslateFunnyLanguagesBaseFeature
{
    ...
    private function _with_timeout(TranslateFunnyLanguagesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TranslateFunnyLanguagesContext $_ctx, float $ms): void
    {
        $client = $this->client;
