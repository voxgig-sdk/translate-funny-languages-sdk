...
// TranslateFunnyLanguages SDK ratelimit feature
...
class TranslateFunnyLanguagesRatelimitFeature extends TranslateFunnyLanguagesBaseFeature
{
    ...
    private function _acquire(TranslateFunnyLanguagesContext $ctx): void
    {
    ...
    private function _track(TranslateFunnyLanguagesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
