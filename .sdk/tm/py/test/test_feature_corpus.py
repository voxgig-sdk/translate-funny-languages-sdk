# TranslateFunnyLanguages SDK feature corpus test
#
...
def _client(kase):
    ...
    TranslateFunnyLanguagesSDK(...), not TranslateFunnyLanguagesSDK.test(...): the `test` feature is
    ...
    return TranslateFunnyLanguagesSDK(opts)
