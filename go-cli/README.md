...
AQL-driven CLI and REPL for the TranslateFunnyLanguages SDK. Positional arguments are
...
```sh
go build -o translate-funny-languages-cli ./...
```
...
./translate-funny-languages-cli list translator
./translate-funny-languages-cli load 1 translator
./translate-funny-languages-cli load '{id:1}' translator
