...
func registerSDKWords(r *eng.Registry, client *sdk.TranslateFunnyLanguagesSDK) {
...
func runOp(client *sdk.TranslateFunnyLanguagesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
