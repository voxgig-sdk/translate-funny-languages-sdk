...
type Args struct {
	Entity string         `json:"entity" jsonschema:"translator"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TranslateFunnyLanguagesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "translate-funny-languages_list",
		Description: "List records from TranslateFunnyLanguages. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "translate-funny-languages_load",
		Description: "Load a single record from TranslateFunnyLanguages. " +
...
func runOp(client *sdk.TranslateFunnyLanguagesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TranslateFunnyLanguagesSDK, name string) (sdk.TranslateFunnyLanguagesEntity, error) {
	switch strings.ToLower(name) {
	case "translator":
		return client.Translator(nil), nil
