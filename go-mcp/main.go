// Command TranslateFunnyLanguages-mcp is an MCP server exposing the TranslateFunnyLanguages
// SDK as MCP tools.
//
// Two tools are registered:
//
//	TranslateFunnyLanguages_list  — list records of an entity
//	TranslateFunnyLanguages_load  — load a single record of an entity
//
